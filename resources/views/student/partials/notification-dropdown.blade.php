...
<div
    class="relative"
    id="student-notification-root"
    data-poll-url="{{ route('student.notifications.poll') }}"
>
    <button
        type="button"
    ...
    >
        ...
        <div id="student-notification-list" class="max-h-[22rem] overflow-y-auto">
            {{-- Filled by live polling --}}
        </div>

        <div
            id="student-notification-footer"
