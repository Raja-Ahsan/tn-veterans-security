...
<div class="mx-auto max-w-2xl overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
    <div class="border-b border-gray-100 bg-gray-50 px-5 py-4 sm:px-6">
        <h3 class="text-lg font-bold text-gray-900">Instructor details</h3>
        <p class="mt-0.5 text-sm text-gray-500">Only name is required. Email/phone help with notifications.</p>
    </div>
    <form method="POST" action="{{ route('admin.instructors.store') }}" class="space-y-6 p-5 sm:p-6">
        @csrf
