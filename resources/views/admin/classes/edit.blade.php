...
<form method="POST" action="{{ route('admin.classes.update', ['service' => $service]) }}" enctype="multipart/form-data" class="space-y-6 pb-24">
        ...
        <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <p class="mb-4 text-sm text-gray-600">Categories are optional. Use a direct page slug above for standalone classes.</p>
            <div class="mb-4 space-y-4">
                @include('admin.classes.partials.category-fields', [
                    'selectedCategories' => old('categories', $service->categories ?? []),
                    'subcategoryValue' => old('subcategory', $service->subcategory),
                ])
                ...
                <div>
                    ...
                    <select id="location"
                        ...
                        @include('admin.classes.partials.location-options', [
                            ...
                            'selectedLocation' => old('location', $service->location),
                        ])
                    </select>
        ...
        <!-- Related Classes (Linked / Related Trainings) -->
        @php
