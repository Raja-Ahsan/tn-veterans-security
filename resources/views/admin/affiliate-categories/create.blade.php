...
@section('page-title', 'Add Affiliate Category')
...
<div class="mb-5">
    ...
    <p class="mt-1 text-sm text-gray-500">Sections group affiliates on the Partners or NRA pages.</p>
</div>

<form method="POST" action="{{ route('admin.affiliate-categories.store') }}" class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
    @csrf
    ...
    <div class="p-5 sm:p-6">
        @include('admin.affiliate-categories._form', ['category' => null])
    </div>
